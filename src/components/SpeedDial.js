...
function SpeedDial({ url, title, summary }) {
  ...
  const handleShare = () => {
    // Build LinkedIn URL for sharing
  ...
  const handlePrint = () => {
    // Open a new window and insert HTML content for printing
  ...
  const handleDownload = () => {
    // Create a Blob with the summary text and download it
  ...
  const handleCopy = () => {
    // Use navigator API to copy text
